...
impl SynapseApiMocker {
    ...
    // pub fn cannot_get_room_associated_source_group_id_v1(mut self) -> Self {
    //     self.api_mock
    //         .expect_get_room_associated_source_group_id_v1()
    //         .returning(|_| Err(KidsError::InternalError(error::NO_CONTEXT.to_string())));
    //     self
    ...
    // pub fn cannot_associate_source_group_id_to_room(mut self) -> Self {
    //     self.api_mock
    //         .expect_associate_source_group_id_to_room()
...
impl From<SynapseApiMocker> for Box<dyn external::SynapseApi> {
