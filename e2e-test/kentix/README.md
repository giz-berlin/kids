...
As described in [the Kentix README](../../keycloak-kentix/README.md), a CA is needed to access Kentix.
Place the CA certificate at `./kentix_ca.crt` for the e2e test to automatically pick it up.
