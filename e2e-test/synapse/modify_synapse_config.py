...
with open(CONFIG_FILE) as f:
    ...
    config['matrix_authentication_service'] = {
        'enabled': True,
        'endpoint': f'https://{os.environ.get("PODMAN_SERVICE_HOSTNAME")}:{os.environ.get("MAS_TLS_PORT")}',
        'secret': 'superseecret'
    }
    ...
    config['public_baseurl'] = f'https://{os.environ.get("PODMAN_SERVICE_HOSTNAME")}:{os.environ.get("SYNAPSE_TLS_PORT")}'
